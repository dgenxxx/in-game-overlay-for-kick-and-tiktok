...
class ChatMessage {
    ...
    String platform; // "Kick", "TikTok", or "System"
    ...
    public ChatMessage(String username, String message, Color color, Map<String, String> badges, 
                      boolean isSubscriber, boolean isModerator, boolean isVIP, boolean isBroadcaster, String platform) {
        this(username, message, color, badges, isSubscriber, isModerator, isVIP, isBroadcaster);
